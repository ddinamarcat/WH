...
var calendarioManager = {
    ...
    setOnClickListeners : function(){
        ...
        for(i=0; i<l; i++){
            cal.children[i].addEventListener("click",function(){
                ...
                //cambia titulo
                var titulo = eventosManager.diaEventos.parentElement.children[0];
                titulo.innerHTML = "Eventos del d&iacute;a <span>"+cm.generarStringFecha(this.attributes.dia)+"</span>";
    ...
    generarStringDateTime : function(fecha){
    ...
    generarStringFechaHora : function(fecha){
        var minutos = fecha.getMinutes();
        if(minutos < 10) minutos = "0"+minutos;
        ...
        //return fecha.getFullYear()+"/"+mes+"/"+dia+" "+hora+":"+minutos;
        return fecha.getDate()+" de "+this.getNombreMes(fecha)+" de "+fecha.getFullYear()+", "+hora+":"+minutos+" hrs";
    }
